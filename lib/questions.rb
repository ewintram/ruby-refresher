...
def select_elements_starting_with_vowel(array)
  array.select { |element| element.downcase.start_with?("a","e","i","o","u") }
end
...
def remove_nils_and_false_from_array(array)
  array.reject{ |element| element == false }.compact!
end
...
def get_first_half_of_string(string)
  ...
  string.length % 2 == 0 ? half_length -=1 : half_length
...
def number_of_elements_that_are_palindromes(array)
  count = 0
  array.each{|word| word == word.reverse ? count += 1 : count }
  count
end
